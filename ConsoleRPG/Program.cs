...
namespace ConsoleRPG
{
    class Program
    {
        ...
        public static readonly IMessageService MessageService =
            new ConsoleMessageService(Console.WriteLine, Console.Clear, Console.ReadLine);
        ...
        public static readonly FightingService FightingService =
            new FightingService(new NumbersRandomGenerator(), MessageService);
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                if (player.CurrentLevel.Number == Levels.Count - 1)
                    MessageService.ShowMessage(new Message("У тебя сердце воина,ты ЛУЧШИЙ из ныне живущих!Пока что...",
                        ConsoleColor.Red));
        ...
        static void ShowRecentRuns()
        {
            ...
            if (rating != null)
            {
                MessageService.ShowMessage(new Message("                   Таблица последних сыгранных игр",
                    ConsoleColor.Cyan));
        ...
        static Player CreateCharacter()
        {
            ...
            if (!isNewGame && File.Exists("save.json"))
            {
                ...
                try
                {
                    ...
                    if (loadedPlayer != null)
                        ...
                        MessageService.ShowMessage(new Message("Не удалось найти файл сохранения,либо он пустой!",
                            ConsoleColor.Red));
                }
                catch (Exception e)
                {
            ...
            MessageService.ShowMessage(new Message($"{chosenClass.Name} по имени {name},посмотрим на что ты годишься!",
                ConsoleColor.Yellow));
            Thread.Sleep(sleepTime);
        ...
        public static void FillEnemies()
        {
            Enemies = new List<Enemy>()
            {
                ...
                new Enemy(Tiers.Tier1, Race.Goblin, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 2, "Small goblin", maxHp: 25, damage: 7, armor: 5,
                    lifestealPercent: 0, criticalStrikeChance: 15, asciiArt: AsciiArts.SmallGoblin),
                new Enemy(Tiers.Tier1, Race.Orc, new List<Ability>(), new Inventory(new ObservableCollection<Item>()),
                    4, "Small orc", maxHp: 80, damage: 15, armor: 7,
                    lifestealPercent: 0, criticalStrikeChance: 5),
                new Enemy(Tiers.Tier1, Race.Troll, new List<Ability>(), new Inventory(new ObservableCollection<Item>()),
                    4, "Small troll", maxHp: 55, damage: 17, armor: 5,
                    lifestealPercent: 45, criticalStrikeChance: 5),
                new Enemy(Tiers.Tier1, Race.Gnome, new List<Ability>(), new Inventory(new ObservableCollection<Item>()),
                    3, "Angry gnome", maxHp: 25, damage: 25, armor: 0,
                    lifestealPercent: 0, criticalStrikeChance: 0),
                new Enemy(Tiers.Tier1, Race.MagicCreature, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 2, "Fly-trap", maxHp: 20, damage: 8, armor: 0,
                    lifestealPercent: 0, criticalStrikeChance: 0),
                new Enemy(Tiers.Tier1, Race.MagicCreature, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 3, "Little swamp creature", maxHp: 80, damage: 16,
                    armor: 0, lifestealPercent: 35, criticalStrikeChance: 0),
                new Enemy(Tiers.Tier1, Race.Animal, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 4, "Wild wolf", maxHp: 40, damage: 13, armor: 0,
                    lifestealPercent: 0, criticalStrikeChance: 23, asciiArt: AsciiArts.WildWolf),
                new Enemy(Tiers.Tier1, Race.Animal, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 3, "Small bat", maxHp: 26, damage: 14, armor: 0,
                    lifestealPercent: 65, criticalStrikeChance: 5, asciiArt: AsciiArts.SmallBat),
                new Enemy(Tiers.Tier1, Race.Undead, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 3, "Zombie", maxHp: 40, damage: 18, armor: 2,
                    lifestealPercent: 0, criticalStrikeChance: 0, asciiArt: AsciiArts.Zombie),
                new Enemy(Tiers.Tier1, Race.Cursed, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 6, "Young Blackgate warrior", maxHp: 68,
                    damage: 22, armor: 10, lifestealPercent: 0, criticalStrikeChance: 7,
                    asciiArt: AsciiArts.YoungBlackgateWarrior),

                #endregion

                #region Tier2

                new Enemy(Tiers.Tier2, Race.Animal, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 7, "Small werewolf", maxHp: 120, damage: 32,
                    armor: 0, lifestealPercent: 35, criticalStrikeChance: 10),
                new Enemy(Tiers.Tier2, Race.Goblin, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 4, "Goblin", maxHp: 55, damage: 22, armor: 15,
                    lifestealPercent: 0, criticalStrikeChance: 25),
                new Enemy(Tiers.Tier2, Race.Troll, new List<Ability>(), new Inventory(new ObservableCollection<Item>()),
                    5, "Wounded troll", maxHp: 75, damage: 44,
                    armor: 35, lifestealPercent: 55, criticalStrikeChance: 7),
                new Enemy(Tiers.Tier2, Race.Animal, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 5, "Mediocre size bear", maxHp: 140, damage: 45,
                    armor: 0, lifestealPercent: 0, criticalStrikeChance: 15),
                new Enemy(Tiers.Tier2, Race.Elf, new List<Ability>(), new Inventory(new ObservableCollection<Item>()),
                    8, "Cursed elf", maxHp: 55, damage: 39, armor: 22,
                    lifestealPercent: 0, criticalStrikeChance: 35),
                new Enemy(Tiers.Tier2, Race.Animal, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 5, "Big hungry boar", maxHp: 180, damage: 41,
                    armor: 0, lifestealPercent: 0, criticalStrikeChance: 10, asciiArt: AsciiArts.BigHungryBoar),
                new Enemy(Tiers.Tier2, Race.Animal, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 4, "Bat swarm", maxHp: 150, damage: 40, armor: 0,
                    lifestealPercent: 65, criticalStrikeChance: 0, asciiArt: AsciiArts.BatSwarm),
                new Enemy(Tiers.Tier2, Race.Cursed, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 7, "Cursed Iron knight", maxHp: 90, damage: 37,
                    armor: 25, lifestealPercent: 0, criticalStrikeChance: 17),
                new Enemy(Tiers.Tier2, Race.Human, new List<Ability>(), new Inventory(new ObservableCollection<Item>()),
                    8, "Aztec warrior", maxHp: 65, damage: 50,
                    armor: 15, lifestealPercent: 20, criticalStrikeChance: 20),
                new Enemy(Tiers.Tier2, Race.Goblin, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 10, "Goblin-assassin", maxHp: 60, damage: 65,
                ...
                new Enemy(Tiers.Tier3, Race.Animal, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 10, "Werewolf", maxHp: 260, damage: 78, armor: 0,
                    lifestealPercent: 41, criticalStrikeChance: 15),
                new Enemy(Tiers.Tier3, Race.Gnome, new List<Ability>(), new Inventory(new ObservableCollection<Item>()),
                    15, "Proffesional Goblin-assassin", maxHp: 85,
                    damage: 70, armor: 20, lifestealPercent: 0, criticalStrikeChance: 80),
                new Enemy(Tiers.Tier3, Race.Troll, new List<Ability>(), new Inventory(new ObservableCollection<Item>()),
                    8, "Troll", maxHp: 130, damage: 62, armor: 40,
                    lifestealPercent: 50, criticalStrikeChance: 10),
                new Enemy(Tiers.Tier3, Race.Animal, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 7, "Mother bear", maxHp: 205, damage: 68,
                    armor: 0, lifestealPercent: 0, criticalStrikeChance: 20, asciiArt: AsciiArts.MotherBear),
                new Enemy(Tiers.Tier3, Race.Orc, new List<Ability>(), new Inventory(new ObservableCollection<Item>()),
                    9, "Orc-warrior", maxHp: 110, damage: 55,
                    armor: 55, lifestealPercent: 0, criticalStrikeChance: 20),
                new Enemy(Tiers.Tier3, Race.MagicCreature, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 8, "Swamp creature", maxHp: 400, damage: 60,
                    armor: 0, lifestealPercent: 40, criticalStrikeChance: 0),
                new Enemy(Tiers.Tier3, Race.Undead, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 9, "Vampire", maxHp: 135, damage: 66, armor: 32,
                    lifestealPercent: 100, criticalStrikeChance: 15, asciiArt: AsciiArts.Vampire),
                new Enemy(Tiers.Tier3, Race.Cursed, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 9, "Cursed Paladin", maxHp: 140, damage: 82,
                    armor: 70, lifestealPercent: 0, criticalStrikeChance: 21),
                new Enemy(Tiers.Tier3, Race.Human, new List<Ability>(), new Inventory(new ObservableCollection<Item>()),
                    11, "Aztec voodoo-warior", maxHp: 115, damage: 66,
                    armor: 43, lifestealPercent: 25, criticalStrikeChance: 16),
                new Enemy(Tiers.Tier3, Race.Ogre, new List<Ability>(), new Inventory(new ObservableCollection<Item>()),
                    7, "Ogre", maxHp: 365, damage: 130, armor: 0,
                ...
                new Enemy(Tiers.Tier4, Race.MagicCreature, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 10, "Little dragon", maxHp: 450, damage: 220,
                    armor: 0, lifestealPercent: 0, criticalStrikeChance: 0, asciiArt: AsciiArts.LittleDragon),
                new Enemy(Tiers.Tier4, Race.Goblin, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 21, "Goblin back-stabber", maxHp: 150, damage: 135,
                    armor: 55, lifestealPercent: 0, criticalStrikeChance: 85),
                new Enemy(Tiers.Tier4, Race.Troll, new List<Ability>(), new Inventory(new ObservableCollection<Item>()),
                    11, "Angry troll", maxHp: 200, damage: 150,
                    armor: 80, lifestealPercent: 65, criticalStrikeChance: 10),
                new Enemy(Tiers.Tier4, Race.Animal, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 12, "Ursa", maxHp: 380, damage: 170, armor: 0,
                    lifestealPercent: 35, criticalStrikeChance: 15),
                new Enemy(Tiers.Tier4, Race.Cursed, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 10, "Cursed Paladin's sword", maxHp: 210,
                    damage: 180, armor: 0, lifestealPercent: 0, criticalStrikeChance: 22),
                new Enemy(Tiers.Tier4, Race.MagicCreature, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 8, "Big Swamp thing", maxHp: 520, damage: 160,
                    armor: 0, lifestealPercent: 30, criticalStrikeChance: 0),
                new Enemy(Tiers.Tier4, Race.Undead, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 13, "Dracula", maxHp: 220, damage: 195, armor: 80,
                    lifestealPercent: 100, criticalStrikeChance: 10),
                new Enemy(Tiers.Tier4, Race.Elf, new List<Ability>(), new Inventory(new ObservableCollection<Item>()),
                    14, "Elf dead-eye", maxHp: 120, damage: 177,
                    armor: 60, lifestealPercent: 0, criticalStrikeChance: 59),
                new Enemy(Tiers.Tier4, Race.MagicCreature, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 9, "Big Treant", maxHp: 600, damage: 250, armor: 0,
                    lifestealPercent: 0, criticalStrikeChance: 0),
                new Enemy(Tiers.Tier4, Race.Cursed, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 11, "Cursed mage", maxHp: 140, damage: 225,
                ...
                new Enemy(Tiers.Tier5, Race.MagicCreature, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 100, "Mediocre dragon", maxHp: 1100, damage: 425,
                    armor: 0,
                    lifestealPercent: 0, criticalStrikeChance: 0),
                new Enemy(Tiers.Tier5, Race.Troll, new List<Ability>(), new Inventory(new ObservableCollection<Item>()),
                    100, "Troll warlord", maxHp: 600, damage: 300,
                    armor: 190, lifestealPercent: 60, criticalStrikeChance: 10),
                new Enemy(Tiers.Tier5, Race.Human, new List<Ability>(), new Inventory(new ObservableCollection<Item>()),
                    100, "Aztec king", maxHp: 525, damage: 235,
                    armor: 150, lifestealPercent: 25, criticalStrikeChance: 25),
                new Enemy(Tiers.Tier5, Race.Animal, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 100, "Ursa warrior", maxHp: 780, damage: 400,
                    armor: 90, lifestealPercent: 35, criticalStrikeChance: 8),
                new Enemy(Tiers.Tier5, Race.MagicCreature, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 100, "Treant protector", maxHp: 1400, damage: 390,
                    armor: 0, lifestealPercent: 0, criticalStrikeChance: 0),
                new Enemy(Tiers.Tier5, Race.Animal, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 100, "Wild dog's group", maxHp: 600, damage: 350,
                    armor: 0, lifestealPercent: 10, criticalStrikeChance: 30),
                new Enemy(Tiers.Tier5, Race.Human, new List<Ability>(), new Inventory(new ObservableCollection<Item>()),
                    100, "Zeus", maxHp: 525, damage: 390, armor: 200,
                    lifestealPercent: 0, criticalStrikeChance: 15),
                new Enemy(Tiers.Tier5, Race.Elf, new List<Ability>(), new Inventory(new ObservableCollection<Item>()),
                    100, "Legolas", maxHp: 400, damage: 300, armor: 150,
                    lifestealPercent: 0, criticalStrikeChance: 25),
                new Enemy(Tiers.Tier5, Race.Human, new List<Ability>(), new Inventory(new ObservableCollection<Item>()),
                    100, "Cursed Arthur", maxHp: 675, damage: 275,
                    armor: 325, lifestealPercent: 10, criticalStrikeChance: 10),
                new Enemy(Tiers.Tier5, Race.MagicCreature, new List<Ability>(),
                    new Inventory(new ObservableCollection<Item>()), 100, "Volcano", maxHp: 1800, damage: 500, armor: 0,
                    lifestealPercent: 0, criticalStrikeChance: 0),
        ...
        public static void FillItems()
        {
...

            {
                ...
                new Weapon(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Sneaky blow", "Скрытный удар,которого не ожидал противник",
                        new Dictionary<string, int>()
                            {{StatsConstants.CritChanceStat, 40}, {StatsConstants.DamageStat, 10}},
                ...
                new Item(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Soul assumption",
                        "Когда вы наносите критический удар,вы поглощаете часть души врага на время",
                ...
                new Weapon(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Blood magic", "Магия старой крови на время восполняет вашу жизненную силу",
                        new Dictionary<string, int>()
                            {{StatsConstants.LifestealStat, 200}, {StatsConstants.HpStat, 50}},
                ...
                new Item(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Ancient call", "Оказалось что это кольцо не простое",
                        new Dictionary<string, int>()
                            {{StatsConstants.CritChanceStat, 15}, {StatsConstants.MaxHpStat, 40}},
                        new Dictionary<string, double>()
                            {{StatsConstants.LifestealStat, 0.25}, {StatsConstants.DamageStat, 0.25}},
                        ActiveAbilityType.PlayerUseAbility, 17, 2)),
                ...
                new Item(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Fiery skin",
                        "Когда враг наносит вам критический удар,ваше оружие загорается огнем на время",
                ...
                new Weapon(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Grim cut", "Удар,который затемняет разум противника",
                        new Dictionary<string, int>()
                            {{StatsConstants.DamageStat, 100}, {StatsConstants.LifestealStat, 25}},
                ...
                new Item(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Charged armour",
                        "Вы расходуете накопленный заряд и превосходите в бою своих противников",
                ...
                new Weapon(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Deadly slash", "Точный,чистый удар",
                        new Dictionary<string, int>()
                            {{StatsConstants.DamageStat, 30}, {StatsConstants.CritChanceStat, 70}},
                        new Dictionary<string, double>(), ActiveAbilityType.PlayerUseAbility, 10, 1)),
                ...
                new Weapon(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Ogre's thickskin",
                        "После того как вы нанесли критический удар,ваша кожа утолщается на время",
                        new Dictionary<string, int>(),
                        new Dictionary<string, double>() {{StatsConstants.ArmorStat, 0.25}},
                        ActiveAbilityType.PlayerCrit, 20, 2)),
                ...
                new Item(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Vibration block", "Атаки ваших противников отбрасывают их",
                        ...
                        new Dictionary<string, double>() {{StatsConstants.ArmorStat, 0.20}},
                        ActiveAbilityType.PlayerUseAbility, 12, 3)),
                ...
                new Weapon(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Battle-born", "Смерть противника вдохновляет вас",
                        new Dictionary<string, int>(),
                        new Dictionary<string, double>()
                            {{StatsConstants.DamageStat, 0.15}, {StatsConstants.ArmorStat, 0.15}},
                        ActiveAbilityType.EnemyDeath, 10, 3)),
                ...
                new Item(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Wild rage", "Животна ярость просыпается внутри вас",
                        new Dictionary<string, int>()
                            {{StatsConstants.LifestealStat, 10}, {StatsConstants.DamageStat, 25}},
                        new Dictionary<string, double>() {{StatsConstants.DamageStat, 0.10}},
                        ActiveAbilityType.PlayerUseAbility, 25, 10)),
                ...
                new Weapon(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Enrage", "Тролли всегда славились своей боевой яростью",
                        new Dictionary<string, int>()
                            {{StatsConstants.DamageStat, 40}, {StatsConstants.CritChanceStat, 20}},
                ...
                new Weapon(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Mythril protection", "Мифрил ненадолго окутывает вас защитным полем",
                        ...
                        new Dictionary<string, double>() {{StatsConstants.ArmorStat, 1.00}},
                        ActiveAbilityType.PlayerUseAbility, 13, 3)),
                ...
                new Item(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Nature's help", "Сила природы оберегает вас на некоторое время",
                        ...
                        new Dictionary<string, double>() {{StatsConstants.MaxHpStat, 0.40}},
                        ActiveAbilityType.PlayerUseAbility, 18, 4)),
                ...
                new Item(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Fighting advance",
                        "Если вы получаете критический удар в бою,ваша стойкость увеличивается",
                ...
                new Item(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Curse charm", "Смерть ваших врагов проклинает вас",
                        new Dictionary<string, int>()
                            {{StatsConstants.ArmorStat, -100}, {StatsConstants.DamageStat, 150}},
                ...
                new Weapon(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Wooden curse", "Топор вьется шипами и окутывает врагов корнями",
                        new Dictionary<string, int>()
                            {{StatsConstants.DamageStat, 80}, {StatsConstants.CritChanceStat, 35}},
                ...
                new Weapon(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("God's rage", "Ярось богов охватывает вас на мгновения",
                        new Dictionary<string, int>(),
                        new Dictionary<string, double>()
                            {{StatsConstants.DamageStat, 1.00}, {StatsConstants.ArmorStat, 1.00}},
                        ActiveAbilityType.PlayerUseAbility, 10, 2)),
                ...
                new Weapon(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Deadly attacks", "Ваш каждый удар становится все смертельнее",
                        new Dictionary<string, int>(),
                        new Dictionary<string, double>() {{StatsConstants.CritChanceStat, 1.00}},
                        ActiveAbilityType.PlayerCrit, 5, 1)),
                ...
                new Weapon(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Heavy crush",
                        "Вы бьете врага настолько сильно,что его физическая форма отправляется в другое измерение",
                        new Dictionary<string, int>() {{StatsConstants.DamageStat, 100}},
                        new Dictionary<string, double>() {{StatsConstants.DamageStat, 0.50}},
                        ActiveAbilityType.PlayerUseAbility, 11, 1)),
                ...
                new Item(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Shapeshift", "Вы на некоторое время становитесь огромным волком",
                        ...
                        new Dictionary<string, double>()
                            {{StatsConstants.LifestealStat, 0.25}, {StatsConstants.MaxHpStat, 1.00}},
                        ActiveAbilityType.PlayerUseAbility, 16, 4)),
                ...
                new Weapon(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Reverse polarity",
                        "Вы меняете гравитацию и полярность получая контроль над врагами",
                ...
                new Weapon(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Mars might", "Бог войны дарует вам победу в битве",
                        new Dictionary<string, int>(),
                        new Dictionary<string, double>()
                            {{StatsConstants.ArmorStat, 2.00}, {StatsConstants.DamageStat, 2.00}},
                        ActiveAbilityType.PlayerUseAbility, 8, 1)),
                ...
                new Weapon(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Bloodlust", "Жажда крови берет над вами контроль",
                        new Dictionary<string, int>()
                            {{StatsConstants.DamageStat, 150}, {StatsConstants.CritChanceStat, 10}},
                        new Dictionary<string, double>()
                            {{StatsConstants.LifestealStat, 2.00}, {StatsConstants.CritChanceStat, 0.45}},
                        ActiveAbilityType.PlayerUseAbility, 15, 3)),
                ...
                new Item(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Sudden attack", "Внезапная атака в самое слабое место",
                        ...
                        new Dictionary<string, double>() {{StatsConstants.CritChanceStat, 0.75}},
                        ActiveAbilityType.PlayerUseAbility, 8, 1)),
                ...
                new Weapon(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Disembowel", "Удар настолько сильный что погружает врага в землю",
                        ...
                        new Dictionary<string, double>() {{StatsConstants.DamageStat, 0.50}},
                        ActiveAbilityType.PlayerUseAbility, 28, 1)),
                ...
                new Item(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Runic power",
                        "Рунические символы загораются,вы почти покидаете свою материальную форму",
                        new Dictionary<string, int>(),
                        new Dictionary<string, double>() {{StatsConstants.HpStat, 1.00}},
                        ActiveAbilityType.PlayerUseAbility, 10, 2)),
                ...
                new Item(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Olympian metal",
                        "Ваша броня излучает лучи света и ее становиться невозможно повредить",
                        new Dictionary<string, int>() {{StatsConstants.ArmorStat, 300}},
                ...
                new Weapon(new Dictionary<string, int>()
                    ...
                    new ActiveAbility("Precise shot", "Меткий выстрел прямо в сердце",
                        new Dictionary<string, int>(),
                        new Dictionary<string, double>() {{StatsConstants.CritChanceStat, 1.00}},
                        ActiveAbilityType.PlayerUseAbility, 10, 1)),
        ...
        public static void FillRaces()
        {
            ...
            {
                new Player(Race.Human, new List<Ability>(Talents.Where(x => x.Name == "Endurance")),
                    new Inventory(new ObservableCollection<Item>()), START_GOLD, "Human", 70, 7, 5, 0, 15, 5, 5),
                new Player(Race.Giant, new List<Ability>(Talents.Where(x => x.Name == "Inner strength")),
                    new Inventory(new ObservableCollection<Item>()), START_GOLD, "Giant", 125, 26, -4, 0, 0, 8, 0),
                new Player(Race.Elf, new List<Ability>(Talents.Where(x => x.Name == "Precision")),
                    new Inventory(new ObservableCollection<Item>()), START_GOLD, "Elf", 50, 16, 2, 0, 45, 0, 15),
                new Player(Race.Undead, new List<Ability>(Talents.Where(x => x.Name == "Savagery")),
                    new Inventory(new ObservableCollection<Item>()), START_GOLD, "Undead", 90, 12, -2, 40, -5, 5, 0),
                new Player(Race.Troll, new List<Ability>(Talents.Where(x => x.Name == "Dual wielder")),
                    new Inventory(new ObservableCollection<Item>()), START_GOLD, "Troll", 76, 7, 2, 50, 5, 15, 0),
                new Player(Race.Gnome, new List<Ability>(Talents.Where(x => x.Name == "Inner strength")),
                    new Inventory(new ObservableCollection<Item>()), START_GOLD + 3, "Gnome", 45, 5, 8, 0, 10, 8, 3),
                new Player(Race.Orc, new List<Ability>(Talents.Where(x => x.Name == "Endurance")),
                    new Inventory(new ObservableCollection<Item>()), START_GOLD, "Orc", 85, 9, 6, -7, 5, 10, 2),
                new Player(Race.Ogre, new List<Ability>(Talents.Where(x => x.Name == "Two handed wielder")),
                    new Inventory(new ObservableCollection<Item>()), START_GOLD, "Ogre", 170, 48, -10, -15, -15, 0, 0),
                new Player(Race.Cursed, new List<Ability>(Talents.Where(x => x.Name == "Savagery")),
                    new Inventory(new ObservableCollection<Item>()), START_GOLD - 6, "Cursed", 20, 20, 20, 20, 20, 10,
                    10),
                new Player(Race.Goblin, new List<Ability>(Talents.Where(x => x.Name == "Sneaky")),
                    new Inventory(new ObservableCollection<Item>()), START_GOLD + 9, "Goblin", 32, 5, 2, 0, 12, 0, 12)
            };
        ...
        public static void FillTalents()
        {
            Talents = new List<Ability>()
            {
                ...
                {
                    {StatsConstants.ArmorStat, 0.20},
                    {StatsConstants.BlockChanceStat, 0.50},
                ...
                {
                    {StatsConstants.DamageStat, 0.10},
                    {StatsConstants.CritChanceStat, 0.10},
                    {StatsConstants.EvadeChanceStat, 0.50},
                ...
                {
                    {StatsConstants.LifestealStat, 0.75},
                ...
                {
                    {StatsConstants.CritChanceStat, 0.20},
                    {StatsConstants.EvadeChanceStat, 0.35},
                }, PassiveAbilityType.WithWeapon, "Sneaky"),

                new PassiveAbility("Dual wielder", "Умение обращаться с оружиями в двух руках",
                    new Dictionary<string, int>()
                    {
                        {StatsConstants.LifestealStat, 10}
                    }, new Dictionary<string, double>()
                    {
                        ...
                        {StatsConstants.BlockChanceStat, 0.35},
                    }, PassiveAbilityType.WithWeapon, "Dual wielder"),

                new PassiveAbility("Two handed wielder", "Умение обращаться с двуручными оружиями",
                    new Dictionary<string, int>()
                    {
                        {StatsConstants.MaxHpStat, 30},
        ...
        public static void FillItemCommands()
        {
            ItemCommands = new Dictionary<string, Func<Item, bool>>()
            {
                ...
                {
                    "Two handed wielder", item => { return item.Type == ItemType.TwoHandedWeapon; }
                },


                {
                    "Dual wielder", item => { return item.Type == ItemType.OneHandedWeapon; }
                },
        ...
        public static void FillBonuses()
        {
            StatBonuses = new List<StatBonus>
            {
                #region Tier2

                new StatBonus(Tiers.Tier2, new Dictionary<string, int>
                {
                    {StatsConstants.MaxHpStat, 20},
                ...
                new StatBonus(Tiers.Tier2, new Dictionary<string, int>
                {
                    {StatsConstants.EvadeChanceStat, 6},
                    {StatsConstants.BlockChanceStat, 6},
                }),
                new StatBonus(Tiers.Tier2, new Dictionary<string, int>
                {
                    {StatsConstants.LifestealStat, 7},
                    {StatsConstants.MaxHpStat, 15},
                }),
                new StatBonus(Tiers.Tier2, new Dictionary<string, int>
                {
                ...
                new StatBonus(Tiers.Tier3, new Dictionary<string, int>
                {
                    {StatsConstants.MaxHpStat, 40},
                    {StatsConstants.HpStat, 40},
                }),
                ...
                new StatBonus(Tiers.Tier4, new Dictionary<string, int>
                {
                    {StatsConstants.MaxHpStat, 60},
                ...
                new StatBonus(Tiers.Tier4, new Dictionary<string, int>
                {
                    {StatsConstants.EvadeChanceStat, 13},
                    {StatsConstants.BlockChanceStat, 13},
                }),
                new StatBonus(Tiers.Tier4, new Dictionary<string, int>
                {
                ...
                new StatBonus(Tiers.Tier5, new Dictionary<string, int>
                {
                    {StatsConstants.MaxHpStat, 80},
